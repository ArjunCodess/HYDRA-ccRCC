...
GSE53757 has no shared patient id for every pair. All 72 adjacent pairs are opposite tissues and the same stage, and four also share a title token. The unpaired limma sensitivity kept all 23 high-confidence genes in the reproducibility gate. Jaccard overlap with the paired reproducible list was 0.998.
